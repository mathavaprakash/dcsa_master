		...
		<link rel="stylesheet" href="../assets/css/main.css" />
            ...
            jQuery(function(){
                ...
                jQuery("#moblie").validate({
                    expression:"if(VAL.match(/^[9 | 8 |7][0-9]{9}$/)) && VAL) return true; else return false;",
									...
									<form method="post" action="#">
                                       ...
                                       <div class="row uniform 50%">
											<div class="12u 12u(mobilep)"> Your First Name *
												<input type="text" name="fname" id="fname" value="<?php print "$table_fname"; ?>" placeholder="First Name" disabled="true"  />
											</div>
                                                                               </div>
                                                                                <div class="row uniform 50%">
											<div class="12u 12u(mobilep)"> Your Last Name 
												<input type="text" name="lname" id="lname" value="<?php print "$table_lname"; ?>" placeholder="Last Name" disabled="true"  />
											</div>
										</div>
...
<?php
        ...
        {      
            ...
            mysql_query("update mas_students SET Gender='$gender',Mobile=$mobile,Email='$email' WHERE Student_Key = $user_id");
            ...
            print '<script>window.location.assign("student_profile_view.php");</script>';
        }
?>
	</body>
</html>