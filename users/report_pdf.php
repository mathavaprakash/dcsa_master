...
$pdf->Cell(50, 6, 'Submit Date', 1, 0, 'L', 1);
$pdf->Cell(13, 6, 'Marks', 1, 0, 'L', 1);
$row_height = 6;
$y_axis = $y_axis_initial + $row_height;
//Select the Products you want to show in your PDF file


$result=mysql_query("SELECT * FROM temp_report_assign") or die(mysql_error());
...
$pdf->Cell(50, 6, $sub_date, 1, 0, 'L', 1);
$pdf->Cell(13, 6, $marks, 1, 0, 'L', 1);
