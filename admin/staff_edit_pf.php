							...
							<!-- Form -->
								<section id="cta">
									...
									<form method="post" action="#">
										...
										<div class="row uniform 50%">
											<div class="12u 12u(mobilep)">
                                            <input type="text" name="designation" id="designation"  value="<?php print "$table_designation"; ?>" placeholder="Designation" />
											</div>
										</div>
                                        <div class="row uniform 50%">
											<div class="12u 12u(mobilep)">
                                            <input type="text" name="role" id="role"  value="<?php print "$table_role"; ?>" placeholder="Role" />
											</div>
										</div>
...
<?php
      include_once "../assets/db/dbdcsa.php";
        ...
        {      
            ...
            mysql_query("update mas_staff SET First_Name='$fname',Last_Name='$lname',Gender='$gender',Mobile=$mobile,Email='$email',Designation='$designation',Role='$role' WHERE Staff_Key = $user_id");
