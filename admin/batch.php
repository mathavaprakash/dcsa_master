...
?>
  ...
  <div class="row uniform 50%">
  <div class="12u 12u(mobilep)">
<center><input type="submit" name="btn1" value="Add"/><input type="button" id="btn2" name="btn2" value="Add the new course" onclick="window.location='new_class.php';"/></center>
...
//echo "new uesr added";
print '<script>alert("New batch added Successfully")</script>';
print '<script>window.location.assign("batch.php");</script>';
