...
$table_pwd=$row['password'];
            ...
            mysql_query("INSERT INTO `dcsa`.`operator_dcsap` (`userid`, `fname`, `lname`, `gender`, `mobile`, `email`, `password`) VALUES ('$userid', '$fname', '$lname', '$gender', '$mobile', '$email', '$pwd' )");
           
			 print '<script>alert(" user added ")</script>';
